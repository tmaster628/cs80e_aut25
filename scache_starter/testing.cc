 ...
 * Author: Trip Master
 * --------------------
 * This file contains a simple testing harness for the SCache.
 * The harness is not meant to be totally comprehensive, but it
 * covers the basics of MSI coherence. Students are encouraged to
 * modify this harness to help them debug their code, but an understanding
 * of what's going on here is not required to complete the assignment.
 * 
...
bool test_scache2() {
    ...
    // STRDDUP'ing the second string should prevent address collisions.
